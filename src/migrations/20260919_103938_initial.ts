...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_contact_limits_fk" FOREIGN KEY ("contact_limits_id") REFERENCES "public"."contact_limits"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE UNIQUE INDEX "contact_limits_key_idx" ON "contact_limits" USING btree ("key");
  CREATE INDEX "contact_limits_expires_at_idx" ON "contact_limits" USING btree ("expires_at");
  CREATE INDEX "contact_limits_updated_at_idx" ON "contact_limits" USING btree ("updated_at");
  CREATE INDEX "contact_limits_created_at_idx" ON "contact_limits" USING btree ("created_at");
  ...
  CREATE INDEX "payload_locked_documents_rels_contact_limits_id_idx" ON "payload_locked_documents_rels" USING btree ("contact_limits_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "contact_limits" CASCADE;
