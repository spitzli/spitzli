...
export interface Config {
  ...
  collectionsSelect: {
    ...
    'contact-limits': ContactLimitsSelect<false> | ContactLimitsSelect<true>;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "contact-limits".
 */
...
export interface PayloadLockedDocument {
  ...
  document?:
    ...
    | ({
        relationTo: 'contact-limits';
        value: number | ContactLimit;
      } | null);
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "contact-limits_select".
 */
export interface ContactLimitsSelect<T extends boolean = true> {
  key?: T;
  hits?: T;
  expiresAt?: T;
  updatedAt?: T;
